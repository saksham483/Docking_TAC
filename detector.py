...
from sensor_msgs.msg import Image  # <--- NEW: Import Image message
from cv_bridge import CvBridge     # <--- NEW: Import CvBridge
...
# [PoseFilter class remains the same as your provided code]
class PoseFilter:
...
class DockingPublisher(Node):
    def __init__(self):
        ...
        # Legacy Aruco Syntax (Based on your working code)
        ...
        # Use CAP_V4L2 to avoid memory errors
        ...
        self.bridge = CvBridge()  # <--- NEW: Initialize Bridge
        ...
        # <--- NEW: Publisher for the video stream
        self.image_pub = self.create_publisher(Image, 'aruco_frames', 10)

        self.timer = self.create_timer(0.05, self.timer_callback)
        self.get_logger().info("Docking Node with Image Stream Started.")

    def load_calibration(self, path):
        # [Calibration loading logic remains the same]
    ...
    def timer_callback(self):
        ...
        # Draw the command text on the frame regardless of detection
